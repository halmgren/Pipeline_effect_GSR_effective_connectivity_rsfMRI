function Figure_influence_spectral_btwn_ntwrk_paper_GSR_option4(SPM_dir,Work_dir)
...
%                         annotation('textbox','string','Parameter: ','Position',[pt1{1}(3)+0.07+0.07-0.1 pt1{1}(4)+0.16-0.5 0.10 0.03],'FontWeight','bold','FontSize',20,'LineStyle','none');
                    ...
                    clear names;
                    if colored==1
                        saveas(gcf,[direct '/' parameter_type{:} '_' ntwrk_abbrev2{network_number} '_colored.bmp']);
                    elseif cntr==1
                        saveas(gcf,[direct '/' parameter_type{:} '_' ntwrk_abbrev2{network_number} '_contour_grey.bmp']);
                    elseif colored_2==1
                        saveas(gcf,[direct '/' parameter_type{:} '_' ntwrk_abbrev2{network_number} '_colored_2.bmp']);
                    end
                    close;
