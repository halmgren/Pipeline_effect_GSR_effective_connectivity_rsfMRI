function Imagesc_group_PEB_GSR_regr_DMN_HCP(SPM_dir,Work_dir)

procedure='GSR_regr';
name_ROI_def='Smith';

load([Work_dir '/Results_paper_GSR/DCM/' procedure '/' name_ROI_def '/Full_model/PEB_group/PEB_A_mean_comp_GSR_regr_HCP_single_DMN.mat'],'PEB','DCM','PEB_group');
load([Work_dir '/DatasetHCP/sub-001_summary/DCM/Basic/Smith/Full_model/GCM_DMN_full_estim.mat']);
DCM=GCM;
...
saveas(gcf,[direct '/Single_A_DMN_matrix_GSR_regr_comp_HCP.bmp']);
close;
