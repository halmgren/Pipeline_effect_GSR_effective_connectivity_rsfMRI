function Imagesc_group_PEB_GSR_regr_SMR(SPM_dir,Work_dir)

procedure='GSR_regr';
name_ROI_def='Smith';

load([Work_dir '/Results_paper_GSR/DCM/' procedure '/' name_ROI_def '/Full_model/PEB_group/PEB_A_mean_comp_GSR_regr_group_single_SMR.mat'],'PEB','DCM','PEB_group');
load([Work_dir '/DatasetKuehn/sub-001_summary/DCM/Basic/Smith/Full_model/GCM_SMR_full_estim.mat']);
DCM=GCM;
...
saveas(gcf,[direct '/Single_A_SMR_matrix_GSR_regr_comp.bmp']);
close;
