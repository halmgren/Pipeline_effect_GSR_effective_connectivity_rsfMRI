function Imagesc_group_PEB_Basic_HCP(SPM_dir,Work_dir)

procedure='Basic';
name_ROI_def='Smith';


load([Work_dir '/Results_paper_GSR/DCM/' procedure '/' name_ROI_def '/Full_model/PEB_group/PEB_A_mean_comp_GSR_regr_HCP_single_TG2.mat'],'PEB','DCM','PEB_group');
load([Work_dir '/DatasetHCP/sub-001_summary/DCM/Basic/Smith/Full_model/GCM_TG2_full_estim.mat']);
DCM=GCM;
...
saveas(gcf,[direct '/Single_A_TG2_matrix_Basic_comp_HCP.bmp']);
close;
