function Extract_timeseries_paper_GSR_HCP(dataset,subject,name_ROI_def,ROI_list,procedure,SPM_dir,Work_dir)
    ...
    if strcmp(procedure,'Basic')||strcmp(procedure,'GSR')||strcmp(procedure,'GSR_regr')
        if 7~=exist(procedure,'dir')
            ...
            elseif strcmp(dataset,'DatasetGordon')
                matlabbatch{1}.spm.stats.fmri_spec.timing.fmri_t0 = 18;
            elseif strcmp(dataset,'DatasetHCP')    %no slice timing correction, so no need to change this
