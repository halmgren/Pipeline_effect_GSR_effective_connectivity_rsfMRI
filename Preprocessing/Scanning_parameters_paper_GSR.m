function Scanning_parameters_paper_GSR(Work_dir)
    ...
    slice_times=[1.105, 0, 1.165, 0.06,	1.2275,	0.1225,	1.2875,	0.185, 1.35, 0.245,	1.41, 0.3075, 1.4725, 0.3675, 1.5325, 0.43,	1.595, 0.49, 1.655,	0.5525,	1.7175,	0.6125,	1.78, 0.675, 1.84, 0.735, 1.9025, 0.7975, 1.9625, 0.8575, 2.025, 0.92, 2.085, 0.9825, 2.1475, 1.0425]*1.0e+03;
    ...
    clear image_dim interlice_gap N_scans TE TR vox_size;
end